...
public class ClassroomCategoryController extends ControllerBase<ClassroomCategoryDto, ClassroomCategory, Identifiable<String>> {
    public ClassroomCategoryController(Logger LOGGER, ServiceBase<ClassroomCategory, Identifiable<String>> service, MapperBase<ClassroomCategoryDto, ClassroomCategory> mapper) {
